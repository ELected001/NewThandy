...
export function buttonClassName(
  ...
  const base =
    "button-effect inline-flex items-center justify-center gap-2 rounded-full font-semibold transition duration-200 ease-[var(--ease-out)] focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[var(--brand-green-500)] focus-visible:ring-offset-2 focus-visible:ring-offset-transparent";
  const sizes = {
